...
#%%
ev.sigma_MCC_plot(ev.Z_NMI_results)

# ev.sigma_MCC_plot(ev.A_NMI_results, type = "individual")


#%%
ev.sigma_NMI_plot(ev.A_NMI_results, type = "combined")
...
#%%
m_cor_plot(ev.Z_cor_results)

sigma_NMI_plot(ev.A_NMI_results)
#%%
